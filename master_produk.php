            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#modalTambahProduk">+ Tambah Data</button>
                    <div class="modal fade" id="btn-tambah" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary"
                                        name="submit-tambah-produk">Tambah</button>
                                </div>
                            </div>
                            </form>
                        </div>
                                ...
                                <form action="tambah_produk.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                            name="simpan_tambahkategori">Simpan</button>
                                    </div>
                                </form>
                            </div>
                        </div>
